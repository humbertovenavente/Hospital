...
const API_URL = process.env.NODE_ENV === 'qa' 
  ? 'http://localhost:8082'  // Puerto del backend en QA
  : 'http://localhost:8080'; // Puerto por defecto

const FRONTEND_URL = process.env.NODE_ENV === 'qa'
  ? 'http://localhost:5175'  // Puerto del frontend en QA
  : 'http://localhost:5174'; // Puerto por defecto

const NGINX_URL = process.env.NODE_ENV === 'qa'
  ? 'http://localhost:8083'  // Puerto de nginx en QA
  : 'http://localhost:8080'; // Puerto por defecto
