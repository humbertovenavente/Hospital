...
# Script para configurar protección de branches en GitHub (Repositorios Personales)
# Solo humbertovenavente puede aprobar PRs hacia dev, QA y prod usando CODEOWNERS

echo "🔒 Configurando protección de branches en GitHub (Repositorio Personal)..."
echo "👤 Solo humbertovenavente podrá aprobar PRs hacia dev, QA y prod"
...
show_help() {
    ...
    echo ""
    echo "⚠️  IMPORTANTE: Necesitas un token de GitHub con permisos 'repo'"
}
...
# Función para configurar protección de branch (sin restricciones de usuario)
configure_branch_protection() {
    ...
    # Crear configuración de protección (sin restricciones de usuario)
...
echo "   ✅ Solo $GITHUB_OWNER puede aprobar PRs (via CODEOWNERS)"
echo "   ✅ Se requieren 1 revisión aprobatoria"
echo "   ✅ Se requieren code owner reviews (CODEOWNERS)"
...
echo ""
echo "⚠️  IMPORTANTE: Los branches deben existir antes de aplicar la protección"
echo "💡 La restricción de usuarios se logra mediante el archivo CODEOWNERS"
