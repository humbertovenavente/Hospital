...
export DRONE_SERVER=http://localhost:8001
...
if [ -z "$DRONE_TOKEN" ]; then
    ...
    echo "1. Ve a http://localhost:8001"
...
# SonarQube Token
drone secret add --repository humbertovenavente/Hospital --name SONAR_TOKEN --data "sqa_8f9c9ffeaf833e1486015527efadabc251e75755"

# SonarQube Host URL
drone secret add --repository humbertovenavente/Hospital --name SONAR_HOST_URL --data "http://34.10.223.20:9000"
...
# Docker Registry
drone secret add --repository humbertovenavente/Hospital --name DOCKER_REGISTRY --data "34.10.223.20:5000"
